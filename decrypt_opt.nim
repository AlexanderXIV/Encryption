...
#     if (b and 1) == 1:
#       result = result xor a
#     hi_bit_set = a and 0x80
#     a *= 2
#     if hi_bit_set == 0x80:
#       a = a xor 0x1b
#     b = b div 2

proc mul9(a1: uint8): uint8 =
  var
    a = a1
    hb: uint8
...
proc inv_mix_columns(data: var Block) =
  for i in countup(0, 12, 4):
    let
      ...
      tmp2 = data[i + 2]
      tmp3 = data[i + 3]
    data[i] = tmp0.mul14() xor tmp1.mul11() xor tmp2.mul13() xor tmp3.mul9()
    data[i + 1] = tmp0.mul9() xor tmp1.mul14() xor tmp2.mul11() xor tmp3.mul13()
    data[i + 2] = tmp0.mul13() xor tmp1.mul9() xor tmp2.mul14() xor tmp3.mul11()
    data[i + 3] = tmp0.mul11() xor tmp1.mul13() xor tmp2.mul9() xor tmp3.mul14()
